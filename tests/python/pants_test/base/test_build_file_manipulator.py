...
class BuildFileManipulatorTest(BaseTest):
  ...
  def test_malformed_targets(self):
    ...
    self.add_to_build_file('BUILD', bad_targets)
    ...
    # Probably these exception types should be more granular.
  ...
  def test_simple_targets(self):
    ...
    self.add_to_build_file('BUILD', simple_targets)
    build_file = BuildFile(self.build_root, 'BUILD')
  ...
  def test_comment_rules(self):
    ...
    self.add_to_build_file('BUILD', self.complicated_dep_comments)
    build_file = BuildFile(self.build_root, 'BUILD')
  ...
  def test_target_insertion_bottom(self):
    ...
    self.add_to_build_file('BUILD', self.multi_target_build_string)
    build_file = BuildFile(self.build_root, 'BUILD')
